...
if uploaded_file is not None:
    ...
    st.info("Tidak ada file yang diupload, menggunakan data sample default.")
    data = pd.DataFrame({
        "Month": list(range(1,11)),
        "Sales":[120,140,160,155,210,240,260,250,270,290],
        "TrendScore":[0.1,0.3,0.5,0.4,0.7,0.9,0.95,0.85,0.92,0.97],
        "USD_IDR":[15400,15380,15450,15510,15480,15520,15500,15490,15470,15540]
    })
